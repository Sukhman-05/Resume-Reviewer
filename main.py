...
st.markdown("Upload resume and get AI feedback")

OPENAI_API_KEY = os.getenv("OPENAI_API_KEY")

uploaded_file = st.file_uploader("Upload your resume (TXT ro PDF)", type = ["pdf", "txt"])
...
if analyze and uploaded_file:
    try:
        ...
        Please provide analysis in a clear, structured format with specific recommendations."""
